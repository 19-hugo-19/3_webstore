        ...
        <>
                ...
                <div className="planner-container">
                    ...
                    <div className="planner-info">
                        ...
                        <div onClick={() => {
                            ...
                            className="purchase-buttons"><button>Add to cart</button></div>
                    </div>
                </div>
            </div>
            ...
            <div className="section-container">
                <div className="section-header">
                    ...
                    <p>Choose from our custom tech logos</p>
                </div>
                    ...
                    {stickers.map((sticker, stickerIndex) => {
                        ...
                        return (
                            <div key={stickerIndex} className="sticker-card">
                                <button className="img-button"  onClick={() => {setPortalImage(stickerImgUrl)}}>
                                ...
                                <div className="sticker-info">
                                    ...
                                    className="purchase-buttons" >Add to cart</button>
                                </div>
                            </div>
                        )
                    })}
